...
This is the API reference copied from WinLandCraft 0.1.82-dev. Use [README.md](README.md) for this standalone project's build and install steps.
...
- This standalone project builds its example separately; see README.md.
...
WinLandCraft maintains its frozen API compatibility baseline and a small API-only regression fixture. This standalone project compiles the actual example against the API JAR and verifies that its own JAR contains no API/host classes.
